...
@section('content')
            ...
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <p>Scroll down to see quick links and overviews of your Currency Chest, To do list<br> Order status or get some Help using Nifty.</p>
